...
Переопределить метод jump в дочерних классах. Если
передать методу jump класса dog значение больше 0.5,
...
parrot = Parrot('Patrick', 6, 'Pavel', 1, 0.05, 8, '10.08.2015', 0.1, 0.1, 'all day')
parrot.info()
parrot.info_run()
parrot.info_jump()
parrot.info_sleep()
