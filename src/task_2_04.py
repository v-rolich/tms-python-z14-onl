...
# Индекс одинаковый с (а) потому что это не фактическая копия b = a.copy(),
# а указатель на ячейку в памяти,
# поэтому он не создает новую ячейку памяти, а добавляет элементы в
# уже существующую
